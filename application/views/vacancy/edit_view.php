...
<p class="fs-2">Редагування вакансії</p>
<div>
    <form method="post" enctype="multipart/form-data" style="margin-bottom: 20px">
        <div class="mb-4">
            <label for="exampleInput1" class="form-label">Професія, посада</label>
            <input type="text" required name="title" class="form-control" id="exampleInput1" value="<?= $data[0]['title'] ?>">
        </div>
        <div class="mb-4">
            <label for="exampleInput2" class="form-label">Назва компанії</label>
            <input type="text" required name="company" class="form-control" id="exampleInput2" value="<?= $data[0]['company'] ?>">
        </div>
        <div class="mb-4">
        ...
        <div class="input-group mb-4">
            ...
            <input required type="text" name="salary" class="form-control" id="salary" value="<?= $data[0]['salary'] ?>">
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <?php $rubric = array($data[0]['employment'], 'повна зайнятість','стажування / практика', 'неповна зайнятість','віддалена робота','проектна робота','позмінна робота');?>
        ...
        <div class="input-group mb-4">
            ...
            <input class="form-control" required type="tel" value="<?= $data[0]['contacts'] ?>" id="phone" name="contacts" placeholder="000-00-00-000" pattern="[0-9]{3}[0-9]{2}[0-9]{2}[0-9]{3}">
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            <?php if(is_file('images/vacancys/'.$data[0]['photo'])): ?>
                <img alt="" style="height: 100px; width: 750px" src='/images/vacancys/<?= $data[0]['photo']?>' />
            <?php endif; ?>
        </div>
        <div class="mb-4">
            <label for="formFile" class="form-label">Встановіть фотокартку вашої компанії (1000px X 100px)</label>
            <input value="<?= $data[0]['photo'] ?>" name="photo" accept="image/jpeg,image/png" type="file" id="formFile">
        </div>
